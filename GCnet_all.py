...
class ResNet(nn.Module):
    ...
    def __init__(self, block, block1, num_block, num_classes=100, gc=False):
        ...
        self.conv3_x = self._make_layer1(block, block1, 128, num_block[1], 2, gc=gc)
        self.conv4_x = self._make_layer1(block, block1, 256, num_block[2], 2, gc=gc)
        self.conv5_x = self._make_layer1(block, block1, 512, num_block[3], 2, gc=gc)
